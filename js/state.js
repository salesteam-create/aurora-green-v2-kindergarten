  ...
  window.INITIAL_STATE = {
    ...
    privateVaults: {
      'sultan-vault': {
        ...
        clientName: 'Stavanger kommune',
        description: 'Kommunal barnehage · Grønt Flagg-kandidat',
        assetIds: ['delhi-star'],
        status: 'active',
        createdAt: '2026-02-12',
        suppliers: [
          { id: 'marinepro', name: 'Måltid & Miljø Service AS', role: 'Kjøkken og mat · Energi og oppvarming · Renhold og hygiene', shareEquityPct: 8.5, greenSharesPct: 12, certCounts: { compliant: 3, pending: 1, missing: 1 }, valueContribution: 22_400_000, status: 'active', joinedAt: '2026-01-20' },
          { id: 'nordiccert', name: 'Grønn Eiendomsdrift AS', role: 'Bygg og uteområde · Vann og sanitær · Læring og pedagogikk', shareEquityPct: 6.2, greenSharesPct: 9, certCounts: { compliant: 4, pending: 0, missing: 0 }, valueContribution: 19_100_000, status: 'active', joinedAt: '2026-01-15' },
          { id: 'seagreen', name: 'Renovasjon Vest AS', role: 'Sikkerhet og HMS · Avfall og gjenvinning', shareEquityPct: 4.0, greenSharesPct: 7, certCounts: { compliant: 0, pending: 1, missing: 1 }, valueContribution: 8_700_000, status: 'active', joinedAt: '2026-02-08' },
          { id: 'iso-acoustics', name: 'Inneklima Consult AS', role: 'Inneklima og støymåling (onboarding pågår)', shareEquityPct: 1.8, greenSharesPct: 3, certCounts: { compliant: 0, pending: 0, missing: 1 }, valueContribution: 0, status: 'pending', joinedAt: null },
        ],
      },
      'monaco-vault': {
        id: 'monaco-vault',
        ...
        description: 'Privat barnehage · Grønt Flagg-kandidat',
        assetIds: ['marina-luna'],
        status: 'active',
        createdAt: '2026-03-04',
        suppliers: [
          { id: 'seagreen', name: 'Renovasjon Vest AS', role: 'Alle områder (totalleveranse)', shareEquityPct: 14.0, greenSharesPct: 18, certCounts: { compliant: 7, pending: 0, missing: 1 }, valueContribution: 26_300_000, status: 'active', joinedAt: '2026-02-22' },
          { id: 'monaco-tech', name: 'Pedagogisk Materiell Norge AS', role: 'Læring og pedagogikk – oppgraderinger', shareEquityPct: 2.0, greenSharesPct: 4, certCounts: { compliant: 1, pending: 0, missing: 0 }, valueContribution: 4_100_000, status: 'active', joinedAt: '2026-03-10' },
        ],
      },
      'equinor-vault': {
        id: 'equinor-vault',
        name: 'Ny barnehage (kommer)',
        clientName: 'Rogaland (placeholder)',
        description: 'Onboarding — kommende barnehage',
        assetIds: [],
        status: 'placeholder',
        createdAt: null,
        suppliers: [],
    ...
    dnvQueue: [
      {
        ...
        componentId: 'engine-room', componentName: 'Kjøkken og mat',
        certId: 'marpol-annex-vi', certName: 'Kildesortering av matavfall',
        submittedBy: 'Renovasjon Vest AS',
        submittedAt: '2026-04-19T10:14:00Z',
        docs: ['Kompostrutine_2026.pdf', 'Avfallsregnskap_Q1_2026.pdf'],
        aiNotes: 'Kompostrutine dokumentert og avfallsregnskap ført for første kvartal 2026. Kildesortering bekreftet i alle avdelinger. Anbefaler godkjenning.',
        status: 'pending',
      },
    ],
    ...
    completedReviews: [
      {
        ...
        certId: 'ml-solas-v', certName: 'Bærekraft i årsplanen',
        submittedBy: 'Grønn Eiendomsdrift AS', decidedAt: '2026-04-15T09:00:00Z', decision: 'approved',
        reviewerNotes: 'Årsplan og referater fra miljøråd i god orden. Godkjent uten merknad.',
      },
    ],

    recentActivity: [
      { at: '2026-04-20T11:32:00Z', text: 'Måltid & Miljø Service lastet opp menyplan med klimavurdering.', persona: 'compliance' },
      { at: '2026-04-18T14:10:00Z', text: 'Miljødirektoratet godkjente Internkontroll kjøkken (IK-Mat).', persona: 'dnv' },
      { at: '2026-04-16T08:45:00Z', text: 'Kartleggingsrapport for giftfritt uteområde verifisert.', persona: 'compliance' },
    ],

    compliantEntities: {
      'marinepro':  { name: 'Måltid & Miljø Service AS', components: ['engine-room', 'fuel-emissions', 'accommodation'] },
      'nordiccert': { name: 'Grønn Eiendomsdrift AS',    components: ['hull-structure', 'ballast-water', 'bridge-nav'] },
      'seagreen':   { name: 'Renovasjon Vest AS',        components: ['deck-safety', 'cargo-tanks'] },
    },
    ...
    criteriaFramework: [
      {
        id: 'esg',
        name: 'Avfall og gjenvinning',
        description: 'Kildesortering, kompostering og avfallsreduksjon i barnehagen.',
        weight: 0.30,
      ...
      },
      {
        ...
        description: 'Energibruk, oppvarming og reduksjon av klimafotavtrykk.',
        weight: 0.25,
        ratifiedAt: '2026-01-15',
      ...
      {
        id: 'safety',
        name: 'Helse og sikkerhet',
        description: 'Inneklima, hygiene og barnas sikkerhet.',
        weight: 0.20,
        ratifiedAt: '2026-01-15',
      ...
      {
        id: 'structural',
        name: 'Natur og uteområde',
        description: 'Uteområde, biologisk mangfold og naturopplevelser.',
        weight: 0.15,
        ratifiedAt: '2026-01-15',
      ...
      {
        id: 'labor',
        name: 'Pedagogikk og trivsel',
        description: 'Personalets kompetanse, miljøpedagogikk og barnas trivsel.',
        weight: 0.10,
        ratifiedAt: '2026-01-15',
